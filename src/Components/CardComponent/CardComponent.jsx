        ...
        <div className='card__container' /*style={{ backgroundImage: "url('" + url + "')" }}*/>
            ...
            <section className='card__container__description'>
                ...
                <div className='card__movie__description'>
                    <div>{props.year}</div>
                    <span>&#8729;</span>
                    <div className="card__tr__description" /*style={{display:"flex",justifyContent:"center",alignItems:"center",gap:"0.3rem"}}*/>
                        <img className='card__tr__image'/*style={{ filter: " brightness(0) saturate(100%) invert(100%) sepia(0%) saturate(4028%) hue-rotate(153deg) brightness(114%) contrast(111%)", width: "25%", height: "80%" }}*/ src={logo} />
                        <p style={{ whiteSpace: "nowrap" }}>{props.category}</p>
                    </div>
                    <span>&#8729;</span>
